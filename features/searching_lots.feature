...
Примеры:
  ...
  | Find a residential        | должны содержать все предложения о жилье            | Detached House  | должны содержать только следующие предложения о жилье: Res #1, Res #2         |
  | Find a residential        | должны содержать все предложения о жилье            | Apartment       | должны содержать только следующие предложения о жилье: Res #3                 |
  | Find a residential        | должны содержать все предложения о жилье            | Semi Detached   | должны содержать только следующие предложения о жилье: Res #4                 |
  | Find a residential        | должны содержать все предложения о жилье            | Town House      | должны содержать только следующие предложения о жилье: Res #5                 |
  | Find a residential        | должны содержать все предложения о жилье            | All             | должны содержать все предложения о жилье                                      |

  | Invest money in something | должны содержать все предложения для инвестирования | Detached House  | должны содержать только следующие предложения для инвестирования: Inv #1      |
  | Invest money in something | должны содержать все предложения для инвестирования | Apartment       | должны содержать только следующие предложения для инвестирования: Inv #2      |
  | Invest money in something | должны содержать все предложения для инвестирования | Town House      | должны содержать только следующие предложения для инвестирования: Inv #3      |
  | Invest money in something | должны содержать все предложения для инвестирования | All             | должны содержать все предложения для инвестирования                           |
